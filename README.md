...
-  **Docker** Download and install Docker for your operating system. To do this please go to the official installation page: [Install Docker](https://docs.docker.com/get-docker/), for raspbery pi go [here](https://github.com/Project-Owl/dms-lite-docker/wiki/Docker-Raspberry-Pi).
-  **SQLite** You need to install SQLite on your machine to host the database. Follow the installation for your OS here [SQLite](https://www.sqlite.org/download.html)
